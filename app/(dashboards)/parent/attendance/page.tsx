...
export default function ParentAttendancePage() {
  ...
  // Extract unique classes from attendance data
  const classData = attendanceData?.children_attendance.flatMap(child => 
          ...
          {loading ? (
            ...
            <>
              <Select value={selectedStudent} onValueChange={setSelectedStudent}>
                ...
                <SelectContent>
                  <SelectItem value="all-students">All Students ({attendanceData?.children_attendance.length || 0})</SelectItem>
                  {attendanceData?.children_attendance.map((child) => (
