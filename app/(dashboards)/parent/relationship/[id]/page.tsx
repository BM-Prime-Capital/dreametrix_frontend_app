...
const StudentDetailsPage = ({ params }: { params: { id: string } }) => {
  ...
  const student: StudentDetail = {
    ...
    academic: {
      ...
      homeroom_teacher: "Mrs. Johnson"
    },
    contact: {
      address: "123 Main Street, Boston",
      parent_name: "Jane Smith",
      parent_phone: "+1555123456",
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2 mt-1">
                <span className="text-gray-600">
                  Grade {student.academic.grade} - Class {student.academic.class}
                </span>
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  student.performance.attendance > 90 ? 'bg-green-100 text-green-800' : 
                  student.performance.attendance > 75 ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'
                }`}>
              ...
              <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{formatDate(student.academic.enrollment_date)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Homeroom Teacher</p>
                    <p className="text-sm font-medium">{student.academic.homeroom_teacher}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Address</p>
                    <p className="text-sm font-medium">{student.contact.address}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm font-medium">{student.contact.parent_name}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Parent Phone</p>
                    <p className="text-sm font-medium">{student.contact.parent_phone}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Parent Email</p>
                    <p className="text-sm font-medium">{student.contact.parent_email}</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className={`text-xs font-medium ${
                        student.performance.attendance > 90 ? 'text-green-600' : 
                        student.performance.attendance > 75 ? 'text-yellow-600' : 'text-red-600'
                      }`}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div 
                        className={`h-2.5 rounded-full ${
                          student.performance.attendance > 90 ? 'bg-green-500' : 
                          student.performance.attendance > 75 ? 'bg-yellow-500' : 'bg-red-500'
                        }`}
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-semibold">{student.performance.average}</p>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xl font-semibold text-green-600">
                        {Math.max(...student.courses.map(c => getGradeValue(c.grade)))}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 p-3 rounded-md border border-blue-100">
                      <p className="text-sm text-gray-700">{student.performance.last_eval}</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className={`text-xs font-medium ${
                        ...
                        {student.financial.tuition_status.charAt(0).toUpperCase() + student.financial.tuition_status.slice(1)}
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xl font-semibold">
                        ${student.financial.balance.toFixed(2)}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Last Payment</p>
                      <p className="text-sm font-medium">
                        {formatDate(student.financial.last_payment)}
                      </p>
                    ...
                    <div className="bg-gray-50 p-3 rounded-md border border-gray-200">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className={`font-medium ${
                          student.financial.balance < 1000 ? 'text-green-600' : 'text-red-600'
                        }`}>
                          {student.financial.balance < 1000 ? 'Paid' : 'Pending'}
                        </span>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{student.academic.class}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Enrollment Date</p>
                      <p className="text-sm font-medium">{formatDate(student.academic.enrollment_date)}</p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">Average Grade</p>
                      <p className="text-sm font-medium">{student.performance.average}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Last Evaluation</p>
                      <p className="text-sm font-medium">{student.performance.last_eval}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{formatDate(student.financial.last_payment)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Balance Due</p>
                      <p className="text-sm font-medium">${student.financial.balance.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
              </div>
