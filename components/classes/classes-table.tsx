                ...
                return (
                  <div key={row.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200 overflow-hidden group">
                    ...
                    <div className="border-t border-gray-100 p-4 flex gap-2">
                      ...
                      <AddClassDialog setRefreshTime={setRefreshTime} existingClass={{ ...classData, teacher: typeof classData.teacher === 'object' ? classData.teacher.id : classData.teacher }} trigger={<Button variant="ghost" size="sm" className="px-3 text-gray-600 hover:bg-gray-50 rounded-xl">Edit</Button>} />
                  ...
                  <div key={row.id} className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-all duration-200">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <AddClassDialog setRefreshTime={setRefreshTime} existingClass={{ ...classData, teacher: typeof classData.teacher === 'object' ? classData.teacher.id : classData.teacher }} trigger={<Button variant="ghost" size="sm" className="text-gray-600 hover:bg-gray-50">Edit</Button>} />
