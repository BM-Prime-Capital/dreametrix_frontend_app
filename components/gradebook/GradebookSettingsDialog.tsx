...
export function GradebookSettingsDialog() {
  ...
  const handleSave = () => {
    // TODO: Persist weights via service or context
    console.log("Category weights saved:", weights);
    setOpen(false);
  };

  const totalWeight =
    weights.tests + weights.quizzes + weights.homework + weights.participation;
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  value={weights.tests}
                  onChange={(e) =>
                    handleChange("tests", parseFloat(e.target.value) || 0)
                  }
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("quizzes", parseFloat(e.target.value) || 0)
                  }
