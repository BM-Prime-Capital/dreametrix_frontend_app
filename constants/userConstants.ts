...
export enum userPath {
  ...
  STUDENT_DASHBOARD_PATH = `${userPath.STUDENT_BASE_PATH}${HOME_PAGE_PATH}`,

  PARENT_BASE_PATH = "/parent",
  PARENT_LOGIN_PATH = `${LOGIN_PAGE_PATH}?userType=${userTypeEnum.PARENT}`,
  PARENT_DASHBOARD_PATH = `${userPath.PARENT_BASE_PATH}${HOME_PAGE_PATH}`,
  ...
  TEACHER_DASHBOARD_PATH = `/${userPath.TEACHER_BASE_PATH}${HOME_PAGE_PATH}`,
