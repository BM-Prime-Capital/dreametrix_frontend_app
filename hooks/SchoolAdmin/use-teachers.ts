      ...
      try {
        ...
        if (!response.ok) {
          if (response.status === 401) {
            ...
            throw new Error("Vous n'avez pas la permission d'accéder aux enseignants.")
          } else {
        ...
        const errorMessage = err instanceof Error ? err.message : "Erreur lors de la récupération des enseignants."
